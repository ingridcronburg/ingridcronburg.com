...
<div class="project">
  ...
  <div class="row text-center">
    <a href="https://github.com/ingridcronburg/ingridcronburg.com" target="_blank" class="btn btn-primary">View on GitHub</a>
  </div>
</div>
<div class="project">
  <div class="row text-center">
  ...
  <div class="row text-center">
    <a href="https://github.com/ingridcronburg/mosaic" target="_blank" class="btn btn-primary">View on GitHub</a>
  </div>
</div>
<div class="project">
  <div class="row text-center">
  ...
  <div class="row text-center">
    <div class="text">
      <p class="description">
        ...
        It uses a PostgreSQL database with Sequelize and was built with Express/Node.js on the backend and Angular on the front-end.
      </p>
    </div>
  </div>
  <div class="row text-center">
    <a href="http://www.resource.cool" target="_blank" class="btn btn-primary">View Live Demo</a>
    <a href="https://github.com/ingridcronburg/resource-dot" target="_blank" class="btn btn-primary">View on GitHub</a>
  </div>
</div>
<div class="project">
  <div class="row text-center">
  ...
  <div class="row text-center">
    <div class="text">
      <p class="description">
        ...
        It was built with PHP on the backend and Angular on the front-end.
        If you're interested in a demo, email me for login credentials!
      </p>
    </div>
  </div>
  <div class="row text-center">
    <a href="http://employee-tracker.ingridcronburg.com" target="_blank" class="btn btn-primary">View Live Demo</a>
    <a href="https://github.com/ingridcronburg/employee-tracker" target="_blank" class="btn btn-primary">View on GitHub</a>
  </div>
</div>
<div class="project">
  <div class="row text-center">
  ...
  <div class="row text-center">
    <div class="text">
      <p class="description">
        ...
        It uses data from the OpenFlights Airports database stored in a MySQL database and was built with Express/Node.js on the backend and Angular on the front-end.
      </p>
    </div>
  </div>
  <div class="row text-center">
    <a href="http://flight-path.ingridcronburg.com" target="_blank" class="btn btn-primary">View Live Demo</a>
